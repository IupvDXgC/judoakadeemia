...
const initial: FormState = {
  ...
  contacts: {
    others: [
      {
        firstname: "Ruslan Testib",
        lastname: "Ruslan Testib",
        personalCode: "33333333333",
        phone: "55555555",
        email: "ruslan.testib@test.com",
      },
    ],
  },
  ...
  firstname: "Ruslan Testib",
  lastname: "Ruslan Testib",
  personalCode: "111111111",
  gender: "male",
  birthday: "1970-01-01",
  group_id: 82425,
  applicant_agreement_email: "ruslan.testib@test.com",
  agreement_acceptee_name: "Ruslan Testib",
  heard_from: "friends",
  heard_from_other: "",
};
...
function SuccessMessage() {
  return (
    <div className="flex flex-col items-center justify-center py-20">
      <div className="success-circle mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-green-500">
        <svg
          className="h-10 w-10"
          viewBox="0 0 24 24"
          fill="none"
  ...
  return (
    <div className="mx-auto max-w-3xl p-6">
      {submitSuccess ? (
        ...
        <>
      <h2 className="mb-4 text-xl font-semibold">Liikmetaotlus Judoakadeemia</h2>
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <button
            type="submit"
            disabled={submitting}
            className="rounded bg-black px-5 py-2 text-white hover:bg-zinc-800 disabled:opacity-50"
        >
